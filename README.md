...
| [비바도를 사용한 IP 통합기/하이 레벨 설계(HLx)](hdk/docs/IPI_GUI_Vivado_Setup.md) | IP 및 고수준 합성 개발 통합을 위한 그래픽 인터페이스 개발 경험 | Verilog/VHDL/C | [XDMA Driver](sdk/linux_kernel_drivers/xdma/README.md), [peek/poke](sdk/userspace/README.md) | Simulation, Virtual JTAG | 중급 FPGA 경험이 있는 HW 개발자                        |
